# Proyecto Backend de Hotel Mirador del Valle

En este proyecto se muda el almacenamiento de habitaciones y usuarios del hotel desde el db.json del proyecto Frontend a un Backend desarrollado completamente desde cero.

## Contenido
Back-End controlador de usuarios y habitaciones. 
...
- [Github](https://github.com/lucasecapdevila/hotel-mirador-del-valle-frontend)
